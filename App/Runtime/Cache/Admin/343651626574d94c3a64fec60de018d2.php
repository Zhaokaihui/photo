...
<div class="div_from_aoto" style="width: 500px;">
	<form method='post' id="myForm" action="<?php echo U('Photo/photo_add');?>" enctype="multipart/form-data" >
		<div class="control-group">
			<label class="laber_from">相册封面</label>
			<div class="controls">
				<button type="button" class="img_upload_btn" title="点击上传图片">
					<img class="photo_image_img" src="/Public/images/photoImg/default.png">
				</button>
...
<script type="text/javascript">
	...
	$('#update_btn').click(function(){
		...
		$.ajax({
			type: "POST",
			url: '<?php echo U("Photo/photo_add");?>',
			data: myFormData,
			dataType: "json",
			processData: false,
			contentType: false,
