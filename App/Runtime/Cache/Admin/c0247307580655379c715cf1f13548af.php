...
<body>
    ...
    <div id="layout_right_content" class="layout_right_content">
        ...
        <div class="route_bg">
            ...
            <a id='admin-type'>主题添加</a>
        </div>
        <div class="mian_content">
            <div id="page_content">
                
<div class="div_from_aoto" style="width: 500px;">
	<form method='post' id="myForm" action="<?php echo U('Theme/theme_add');?>" enctype="multipart/form-data" >
		<div class="control-group">
			<label class="laber_from">主题名称</label>
			<div class="controls">
				<input class="input_from" name='theme_name' placeholder="请输入相册名称" value=''>
...
<script type="text/javascript">
	...
	$('#update_btn').click(function(){
		...
		$.ajax({
			type: "POST",
			url: '<?php echo U("Theme/theme_add");?>',
			data: myFormData,
			dataType: "json",
			processData: false,
			contentType: false,
