	...
	<div class='lyq-term'>
		<div role="tabpanel" class="tab-pane" id="user">
			<div class="check-div form-inline" style="height:45px;">
				<div class="col-xs-3">
					<a class="btn btn-yellow btn-xs relation-album-add" par=<?php echo ($theme_id); ?>>添加关联相册</a>
				</div>
				<!-- <div class="col-xs-4">
			...
			<table class="album-data-div" width="100%">
				...
				<?php if(is_array($list)): foreach($list as $key=>$val): ?><tr class="tablebody">
					...
					<td class="col-xs-1" height="150px"><?php echo ($val['album_id']); ?></td>
					<td class="col-xs-1" height="150px"><?php echo ($val['album_name']); ?></td>
					<td class="col-xs-2"><img class="relation_album_img" src='/Public/images/albumImg/<?php echo ($val['album_image']); ?>'></td>
...
<script type="text/javascript">
	$('.del-btn').click(function(){
		...
		layer.alert('',{
			...
			$.ajax({
				type: "GET",
				url: '<?php echo U("Theme/relation_album_del");?>',
				data: {id:par},
				dataType: "json",
	...
	$('.relation-album-add').click(function(){
		...
		layer.open({
	        ...
	        fix: false, //不固定
	        maxmin: true,
	        content: "<?php echo U('Theme/relation_album_add',array('theme_id'=>$theme_id));?>",
