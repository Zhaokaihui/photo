...
<body>
	<div class="htmleaf-container">
		<div class="htmleaf-content" style="padding:2em 0;">
			<div id="buttons"></div>
			<div id="gallery">
				<?php if(is_array($album_list)): foreach($album_list as $key=>$val): ?><img class="album_one" par="<?php echo ($val['id']); ?>" src="/Public/images/albumImg/<?php echo ($val['album_image']); ?>" data-tags="<?php echo ($val['theme_names']); ?>" alt="Alex Man"><?php endforeach; endif; ?>
		    </div>
		</div>
	</div>
<script src="/Public/js/jquery.min.js"></script>
<script src="/Public/js/filter-tags.js"></script>
