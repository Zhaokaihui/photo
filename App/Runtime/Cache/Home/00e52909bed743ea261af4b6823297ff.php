			...
			<div class="container">
				...
				<div id="navbar" class="navbar-collapse collapse navbar-right">
					<ul class="nav navbar-nav">
						...
						<li><a href="#contact"><span data-hover="联系我们">联系我们</span></a></li>
					</ul>
				</div>
			</div>
        </nav>
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
        ...
        <div class="item">
			<img class="second-slide" src="/Public/images/banner2.jpg" alt="Second slide">
        </div>
        <div class="item">
			<img class="third-slide" src="/Public/images/banner3.jpg" alt="Third slide">
        </div>
    </div>
	...
	<div id="features">
		<div class="container">
			<div class="row">
				...
				<div class="col-md-6">
					<img src="/Public/images/service-img.jpg" class="img-responsive slideanim" alt="service">
				</div>
			</div>
		</div><!--/ .container -->
	</div><!--/ #features -->
...
<section class="our-testimonials slideanim" id="testimonials">
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-4 col-md-4">
				<div class="test">
					<img src="/Public/images/test-img1.png" class="img-responsive slideanim" alt="">
			...
			<div class="col-lg-4 col-md-4">
				<div class="test">
					<img src="/Public/images/test-img2.png" class="img-responsive slideanim" alt="">
					<h4 class="text-center slideanim">Lorem Ipsum</h4>
					<p class="t1 slideanim">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>	
				</div>
			</div>
			<div class="col-lg-4 col-md-4">
				<div class="test">
					<img src="/Public/images/test-img3.png" class="img-responsive slideanim" alt="">
					<h4 class="text-center slideanim">Lorem Ipsum</h4>
					<p class="t1 slideanim">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>	
				</div>
			</div>
